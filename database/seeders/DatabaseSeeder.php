...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        product::create([
            "id"=>9,
            "p_image"=>"images/whitecarrot.png",
            "p_name"=>"white carrot",
